...
class CLIP(torch.nn.Module):
    KNOWN_MODELS = {
        # 'CLIP': timm.models.vit_large_patch14_224_clip_laion2b
        'CLIP': timm.models.vit_base_patch32_224_clip_laion2b
        # timm.models.vision_transformer._convert_openai_clip
    }
    def __init__(self, input_shape, hparams):
        super().__init__()
        func = self.KNOWN_MODELS[hparams['backbone']]
...
class Laion2b_L14(torch.nn.Module):
    KNOWN_MODELS = {
        # 'CLIP': timm.models.vit_large_patch14_224_clip_laion2b
        'Laion2b_L14': timm.models.vit_large_patch14_224_clip_laion2b
        # timm.models.vision_transformer._convert_openai_clip
    }
    def __init__(self, input_shape, hparams):
        super().__init__()
