...
if __name__ == "__main__":
    ...
    for name, loader, weights in evals:
        ...
        visualize_tsne(algorithm, loader, weights, device, adapt=False, env= args.test_envs, name=name)
        results[name+'_acc'] = acc
        results[name+'_ent'] = ent
    results_keys = sorted(results.keys())
    print("Visualize Base Model Results")
    ...
    if use_featurer_cache:
        ...
        for name, loader, weights in original_evals:
            loader1, loader2, ent = generate_featurelized_loader(loader, network=algorithm.featurizer, classifier=algorithm.classifier, batch_size=128)
    ...
    for adapt_hparams in adapt_hparams_list:
        ...
        results[name+'_acc'] = acc
        results[name+'_ent'] = ent
        print("Visualizing Adapted Models")
        visualize_tsne(adapted_algorithm, loader, weights, device, adapt=True, env= args.test_envs,name=name)
